...
import {MessageBox,Message} from 'element-ui'
     ...
     *一 request 
            ...
            2.参数：    
                url:                后台请求地址，必填，string ，如"/user/add"
                params:             后台请求参数，选填，Object，默认值{}
...
export const request = (url,params = {},config = {},autoErrorRes = true,autoErrorData = true,autoCancel = true) =>{
    ...
    //处理url传参
    if(!['put','post','patch'].includes(args.methods.toLowerCase())){
    ...
    return axiosCustom(args).then((res) =>{
        ...
        if(autoErrorData && res.data.hasOwnProperty('code') && res.data.code !== 1) {
            ...
            MessageBox.alert(errMsg,"请求返回异常："+ errCode, {confirmButtonText:"确定"})
